...
const _sfc_main = {
  ...
  setup(__props) {
    let statusBarHeight = hooks_system.getstatusBarHeight();
    let titleBarHeight = hooks_system.getTitleBarHeight();
    let FillHeight = hooks_system.getFillHeight.value;
    return (_ctx, _cache) => {
      return {
        ...
        e: common_vendor.unref(FillHeight)
      };
    };
  }
};
